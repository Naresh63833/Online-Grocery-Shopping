...
public class BreakFastAdapter extends RecyclerView.Adapter<BreakFastAdapter.ViewHolder> {
    ...
    public BreakFastAdapter(Context context, List<BreakfastModel> breakfastModelList) {
        this.context = context;
        this.breakfastModelList = breakfastModelList;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull BreakFastAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {

        Glide.with(context).load(breakfastModelList.get(position).getImg_url()).into(holder.imageView);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("type",breakfastModelList.get(position).getType());
