...
public class SellerBreakFastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_break_fast);
        ...
        progressDialog = new ProgressDialog(SellerBreakFastActivity.this);



        mStorageRef = FirebaseStorage.getInstance().getReference("Cereals and Break Fast Food");
                                        ...
                                        db.collection("CerealsandBreakFastFood")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        Toast.makeText(SellerBreakFastActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SellerBreakFastActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                });
                                    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(SellerBreakFastActivity.this, SellerHomeActivity.class);
        startActivity(i);
        finish();
    }
}