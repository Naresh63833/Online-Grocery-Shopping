...
public class SellerOtherProductsActivity extends AppCompatActivity {
    ...
    String name ,description ,rating ,type ,shop_name ,shop_location;
    int price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_other_products);
        ...
        progressDialog = new ProgressDialog(SellerOtherProductsActivity.this);



        mStorageRef = FirebaseStorage.getInstance().getReference("All Images");
                                        ...
                                        db.collection("AllProducts")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        Toast.makeText(SellerOtherProductsActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SellerOtherProductsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                });
                                    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(SellerOtherProductsActivity.this, SellerHomeActivity.class);
        startActivity(i);
        finish();
    }
}