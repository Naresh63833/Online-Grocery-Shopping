...
public class SellerMeatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_meat);
        ...
        progressDialog = new ProgressDialog(SellerMeatActivity.this);



        mStorageRef = FirebaseStorage.getInstance().getReference("MeatandSeaFoods");
                                        ...
                                        db.collection("MeatandSeaFoods")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        Toast.makeText(SellerMeatActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SellerMeatActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                });
                                    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(SellerMeatActivity.this, SellerHomeActivity.class);
        startActivity(i);
        finish();
    }
}