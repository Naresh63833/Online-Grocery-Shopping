...
public class SellerFruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_fruit);
        ...
        progressDialog = new ProgressDialog(SellerFruitActivity.this);



        mStorageRef = FirebaseStorage.getInstance().getReference("Fruits");
                                        ...
                                        db.collection("Fruits")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        Toast.makeText(SellerFruitActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SellerFruitActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                });
                                    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(SellerFruitActivity.this, SellerHomeActivity.class);
        startActivity(i);
        finish();
    }
}