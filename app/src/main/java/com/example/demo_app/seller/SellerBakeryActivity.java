...
public class SellerBakeryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_bakery);
        ...
        progressDialog = new ProgressDialog(SellerBakeryActivity.this);



        mStorageRef = FirebaseStorage.getInstance().getReference("Bakery Eggs and Bread");
                                        ...
                                        db.collection("BakeryEggsandBread")
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                    ...
                                                    public void onSuccess(DocumentReference documentReference) {
                                                        Toast.makeText(SellerBakeryActivity.this, "Upload successful", Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                })
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SellerBakeryActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        progressDialog.dismiss();
                                                    }
                                                });
                                    }
    ...
    public void onBackPressed() {
        Intent i = new Intent(SellerBakeryActivity.this, SellerHomeActivity.class);
        startActivity(i);
        finish();
    }
}