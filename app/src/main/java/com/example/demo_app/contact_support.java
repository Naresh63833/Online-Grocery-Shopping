...
public class contact_support extends AppCompatActivity {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !message.isEmpty() && !phone.isEmpty() && !type.isEmpty() && !date.isEmpty()) {
                    ...
                    typeField.setText("");
                    dateField.setText("");
                    Toast.makeText(contact_support.this, "Your message sent successfully", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(contact_support.this, "All fields are required", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onBackPressed() {
        Intent i = new Intent(contact_support.this,home.class);
        startActivity(i);
        finish();
    }

    public void contactback(View view) {
        Intent i = new Intent(contact_support.this,home.class);
        startActivity(i);
        finish();
    }
